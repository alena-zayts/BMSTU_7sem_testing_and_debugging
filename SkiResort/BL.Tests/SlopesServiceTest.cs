...
//*stub дл€: ISlopesRepository, ILiftsSlopesRepository(вызовы и взаимодействи€, которые исполн€ютс€ SUT к зависимым объектам, чтобы запросить и получить  данные)
...
namespace BL.Tests
{
    ...
    {
        // with fixture
        // тест вызываетс€ с параметрами. какими -- автоматически сгенерированными
        [AllureXunitTheory]
        [AutoMoqData] 
