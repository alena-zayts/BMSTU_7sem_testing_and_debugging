...
allure generate ${PWD}/SkiResort/IntegrationTests/bin/Debug/net6.0/allure-results --clean -o ${PWD}/allure-report-for-integration-tests


echo "[101;93m Showing report [0m"
allure open ${PWD}/allure-report-for-integration-tests
sleep 3
